...
Design Control: Tailor the look and feel of your form, ensuring it matches your brand and aesthetic.
Email Rendering: Customize the appearance of your form submissions when they're sent via email.
Private: While the creation process mimics post creation, these forms do not appear publicly on your website.
== Installation ==
...
How do I customize the email rendering?
Within the form creation/editing section, there's a tab dedicated to email settings. Here, you can define the appearance and content of the emails sent upon form submission.

Are the forms secure?
Absolutely. We employ best practices to ensure your forms and data are secure.

== Screenshots ==
1. The form creation interface.

Easy form creation mimicking the WordPress post interface.
Field customization options.
Designing your form's appearance.
Configuring the appearance and content of email notifications.
== Changelog ==
https://github.com/Influactive360/influactive-forms/releases

== Upgrade Notice ==
To upgrade, simply follow the installation instructions above.
